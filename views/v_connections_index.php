                    ...
                    <tr>
                        ...
                        <table class="main-left" cellspacing="0" cellpadding="0" border="0" style="font-family: Arial, Helvetica, sans-serif; border-right-width: 2px; border-right-color: #b0c0ce; border-right-style: solid;">
                            <tbody>
                                ...
                                <tr>
                                    <td height="0" width="400" bgcolor="#ffffff">
                                    <table class="main-left-breakout" cellpadding="0" cellspacing="6" bgcolor="#fdc578" border="0" style="font-family: Arial, Helvetica, sans-serif; margin-top: 10px; margin-right: 0; margin-bottom: 10px; margin-left: 0;">
                                        <tbody>
                                            <tr>
                                                <td height="0" width="400">
                                                <h2 style="color: #111f43; font-size: 15px; margin-top: 10px; margin-right: 20px; margin-bottom: 3px; margin-left: 15px;"><a href="http://www.do-online.org/JAOA/connections/poll/vote-form.php?poll=11" title="Online poll" style="color: #111f43;">Take Our Online Poll</a></h2>
                                                <p style="font-size: 13px; color: #333333; line-height: 17px; margin-top: 0px; margin-right: 20px; margin-bottom: 10px; margin-left: 15px;">"I would like more information and guidance about how to promote the <i>JAOA</i> to my colleagues and institution."<br>
                                                <strong><a href="http://www.do-online.org/JAOA/connections/poll/vote-form.php?poll=11" title="Online poll" style="color: #111f43;">Click to let us know!</a></strong></p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <tr>
                                    ...
                                    <ul style="font-size: 13px; color: #333333; line-height: 17px; margin-top: 0px; margin-right: 20px;">
                                        ...
                                        <li><a href="http://www.osteopathic.org/inside-aoa/about/leadership/Pages/tenets-of-osteopathic-medicine.aspx" title="Tenets of Osteopathic Medicine" style="color: #111f43;">Tenets of Osteopathic Medicine</a></li>
                                        <li><a href="http://www.osteopathic.org/committees/JAOA-editorial-board/Pages/default.aspx" title="JAOA Editorial Board online workspace" style="color: #111f43;"><i>JAOA</i> Editorial Board online workspace</a></li>
                                    </ul>
...
<br>
                        ...
                        <table class="sidebar" cellspacing="0" cellpadding="0" border="0" style="font-family: Arial, Helvetica, sans-serif;">
                            <tbody>
                                <tr>
                                    ...
                                    <h2 style="margin-bottom: 10px; font-size: 17px; color: #111f43; margin-top: 3px;">Michael A. Seffinger, DO</h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="0" width="212" align="left" style="padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 10px;"><img src="http://aoa-do.informz.net/aoa-do/data/images/connections/seffinger117.jpg" height="139" width="117" style="margin-top: 0px; margin-bottom: 0px;" alt="#" title=""></td>
                                </tr>
                                <tr>
                                    ...
                                    <p style="font-size: 13px; color: #333333; line-height: 17px; margin-top: 0; margin-right: 0; margin-bottom: 0; margin-left: 0;">Professor and chair of the Department of NMM/OMM at the Western University of Health Sciences College of Osteopathic Medicine in the Pacific and the Pacific Northwest, and <em>JAOA</em> associate editor.</p>
                                    ...
                                    <p style="font-size: 13px; color: #333333; line-height: 17px; margin-top: 0; margin-right: 0; margin-bottom: 0; margin-left: 0;">Michigan State University College of Osteopathic Medicine, Class of 1988.</p>
                                    ...
                                    <p style="font-size: 13px; color: #333333; line-height: 17px; margin-top: 0; margin-right: 0; margin-bottom: 0; margin-left: 0;">I want to contribute to this vital communication link that keeps the osteopathic profession alive and viable. I want to facilitate open and productive scientific, peer-reviewed discourse among osteopathic physicians and our students in particular, as well as anyone else interested in osteopathic medicine. I want to promote the <i>JAOA</i> as a professional scientific journal that is interactive, evidence based, and up to date with state-of-the-art concepts about health and disease from an osteopathic perspective.</p>
                                    ...
                                    <p style="font-size: 13px; color: #333333; line-height: 17px; margin-top: 0; margin-right: 0; margin-bottom: 0; margin-left: 0;">Whether it is meaningful to our profession, makes a significant contribution to the scientific literature, describes valid and appropriate methodology, reviews pertinent literature, clearly and accurately reports and interprets the data, and states the conclusions based only on the data obtained. The manuscript should make sense, state its limitations and strengths, and make recommendations for further study. </p>
                                    </td>
                                </tr>
                            </tbody>
                            <tbody>
        ...
        <tr>
            <td height="0" align="center">
            <table class="footer" width="600" cellspacing="0" cellpadding="0" border="0" style="font-family: Arial, Helvetica, sans-serif; margin-top: 5px; margin-right: 5px; margin-bottom: 5px; margin-left: 5px;">
                <tbody>
                    <tr>
                        <td height="0" width="600" align="center" valign="top">
                        <table class="footer" width="600" cellspacing="0" cellpadding="0" border="0" style="font-family: Arial, Helvetica, sans-serif; margin-top: 5px; margin-right: 5px; margin-bottom: 5px; margin-left: 5px;">
                            <tbody>
                                <tr>
                                    <td height="0" width="600">
                                    <p style="font-size: 11px; color: #333333; line-height: 17px; text-align: center; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px;" align="center">An official publication of the American Osteopathic Association</p>
                                    <p style="font-size: 11px; color: #333333; line-height: 17px; text-align: center; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px;" align="center"><a href="http://www.osteopathic.org/JAOA" title="JAOA -- The Journal of the American Osteopathic Association" style="color: #111f43;">www.osteopathic.org/JAOA</a></p>
                                    <p style="font-size: 11px; color: #333333; line-height: 17px; text-align: center; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px;" align="center">Questions? Concerns? Contact <a href="mailto:circulation@osteopathic.org?Subject=Connections%20feedback" style="color: #111f43;">circulation@osteopathic.org</a> (312) 202-8176 &bull; 142 E. Ontario St., Chicago, IL 60611-2864</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
