...
<!--       <textarea name="resources" id="resources_text" rows="24" cols="60"></textarea> -->
    ...
    <button class='btn' name='edit' type="submit">Edit</button><br><br>
    <button class='btn' name='create' type="submit">Create</button><br><br>
    <button class='btn' name='delete' type="submit">Delete</button><br><br>
