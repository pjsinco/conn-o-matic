...
--
-- Host: localhost
-- Generation Time: Jan 24, 2014 at 05:39 PM
...
--
CREATE DATABASE IF NOT EXISTS `rempatri_work_10rempatrick_com` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `rempatri_work_10rempatrick_com`;
...
DROP TABLE IF EXISTS `thedocal_article`;
...
(5, 'OMS Spotlight: "Life happens"', 1390595846, NULL, 'January', 2014, 'Sean Wyman, OMS II, and other will students will write about loss and "life happening" as a medical student. Sean has pulmonary hypertension and had to take a medical leave of absence from school last year. He''s also on a waiting list for lung transplants. We''ll hear from other students who have faced down obstacles to their education.', 6, 5),
(6, 'OMS Spotlight: RowanSOM Community OMM Clinic', 1390595897, NULL, 'January', 2014, 'RowanSOM students have set up and are running a community OMM clinic. In this article, one or two students will detail the process of setting up the clinic and provide advice and tips for others that might want to do the same at their schools.', 6, 5),
...
(14, 'Rock doc', 1390596083, NULL, 'February', 2014, 'Ted Schwartzenfeld, DO, is the top celebrity physician for metro Detroit entertainment venues. He has been treating A-list rock ''n'' roll bands and singers for 40 years. We will learn what this job is like, what the common injuries he treats are, and hear his advice for those who wish to treat celebrities.', 6, 5),
...
(16, 'How osteopathic medicine crossed the Atlantic', 1390605487, NULL, 'January', 2014, 'A historical look at how the A.T. Still''s precepts took root in Europe. We will talk to some of the osteopathic leaders in the UK.', 6, 5),
...
(18, 'Mentorship: How to find a good mentor', 1390605585, NULL, 'February', 2014, 'Story will provide several tips on ways physicians and students can seek out mentors and explore what one should look for in a mentor and novel ways to go about finding one.', 6, 5),
...
--
-- Table structure for table `thedocal_user`
--

DROP TABLE IF EXISTS `thedocal_user`;
...
--
-- Dumping data for table `thedocal_user`
--

INSERT INTO `thedocal_user` (`id`, `user_name`, `f_name`, `l_name`, `title`, `created`, `modified`, `token`, `password`, `last_login`, `timezone`, `email`, `location`) VALUES
(5, NULL, 'Patrick', 'Sinco', 'Managing Editor', NULL, NULL, NULL, NULL, NULL, NULL, 'psinco@osteopathic.org', NULL),
(6, NULL, 'Rose', 'Raymond', 'Staff Editor', NULL, NULL, NULL, NULL, NULL, NULL, 'rraymond@osteopathic.org', NULL),
(7, NULL, 'Carolyn', 'Schierhorn', 'Staff Editor', NULL, NULL, NULL, NULL, NULL, NULL, 'cschierhorn@osteopathic.org', NULL),
(8, NULL, 'Contributor', NULL, 'Contributor', NULL, NULL, NULL, NULL, NULL, NULL, 'thedo@osteopathic.org', NULL);
